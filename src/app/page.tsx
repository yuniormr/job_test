...
export default function Home() {
  return (
   <>
   <header className="relative h-[722px] p-0 pt-[20px]">
       <div className="bg-[#001853] bg-image-numbers h-full w-full absolute top-0 left-0 m-0 -z-10" ></div>
      <Navbar />
       ...
       <div className="flex md:justify-between flex-col md:flex-row h-[600px]">
           ...
           <div className="border-white sm:border-yellow-400 md:border-orange-500 lg:border-red-600 xl:border-red-800 2xl:border-purple-800 border relative w-full h-full">
               <Image src="/images/hero1.svg" alt="Hero Image" fill />
           </div>
       </div>
   </header>
